...
(function() {
    ...
    angular.module('BlurAdmin.pages.person')
        .controller('usrInfoFillCtrl', usrInfoFillCtrl);

    /** @ngInject */
    function usrInfoFillCtrl($scope, $state, $timeout, $filter, BaseInfoFactory, $uibModal, baProgressModal, SSFactory, UsrOpenAccountFactory) {
        ...
        $scope.IDtype = SSFactory.get("IDtype");
        $scope.IDnumber = SSFactory.get("IDnumber");
