...
(function() {
    ...
    angular.module('BlurAdmin.pages.person')
        .controller('freezeThawAccountCtrl', freezeThawAccountCtrl);

    /** @ngInject */
    function freezeThawAccountCtrl($state, $scope, editableOptions, editableThemes) {
        ...
        $scope.searchClick = function() {
            ...
            $state.go("person.freezethawaccount.results");
        }


        $scope.freezeAccountClick = function(rowform) {
            console.log("already Clicked freeze!");
            $scope.eBankState = '冻结';
            rowform.$show();
